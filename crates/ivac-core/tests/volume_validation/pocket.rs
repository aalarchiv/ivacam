...
use ivac_core::project::{OpKind, PocketStrategy};
...
fn pocket_op() -> ivac_core::project::Op {
    ...
    op_single_pass(
        ...
        OpKind::Pocket {
            ...
            contour: ivac_core::project::ContourParams::default(),
...
fn pocket_rectangle_volume_matches_closed_form() {
    ...
    let n_bytes = dump_stl(&hm, "/tmp/ivac_pocket_rect.stl", -(STOCK_THICK as f32));
    eprintln!("[esnw] STL → /tmp/ivac_pocket_rect.stl ({n_bytes} bytes)");
